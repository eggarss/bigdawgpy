...
client = commands.Bot(description="Hello", command_prefix=".", self_bot=True)
bot = discord.Client()
...
async def status_task():
    while True:
        ...
        await bot.change_presence(activity=discord.Game(name='pis nahuj'))
        await asyncio.sleep(10)
        await bot.change_presence(activity=discord.Game(name='turi muti'))
        await asyncio.sleep(10)
        await bot.change_presence(activity=discord.Game(name='woof'))
        await asyncio.sleep(10)
        await bot.change_presence(activity=discord.Game(name='pis pa muti/pis prom'))
        await asyncio.sleep(10)
        await bot.change_presence(activity=discord.Game(name='atpisies ble'))
        await asyncio.sleep(10)
